...
> Built by Thomas McLeod. Forged by 170+ AI agents across 7 fictional universes.
...
type Universe = "tolkien" | "marvel" | "dc" | "star-wars" | "star-trek" | "dune" | "anime";
...
2. Sees 7 pattern cards in a grid: pattern name, what it teaches, and a 3-line code preview
...
- **Numbers are always specific**: "170+ agents across 7 universes" not "lots of agents"
