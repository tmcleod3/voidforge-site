...
export const metadata: Metadata = {
  ...
  description:
    "The complete guide to building production apps with 240+ AI agents across 7 fictional universes. Drop in a PRD, run /build, ship to production.",
    ...
    images: [
      {
        ...
        width: 1792,
        height: 1024,
        alt: "VoidForge — From Nothing, Everything. 240+ AI agents across 7 fictional universes.",
      },
    ],
  },
  twitter: {
