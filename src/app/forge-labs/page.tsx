...
const tools = [
  ...
  },
  {
    ...
    description:
      "Cross-project financial aggregation. If you run multiple VoidForge projects, Dockson consolidates spend, revenue, and budget across all of them. Anomaly detection. Portfolio optimization. Encrypted backup.",
