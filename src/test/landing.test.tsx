...
describe("Landing Page — Comic Strip", () => {
  it("renders all 3 panels", () => {
    ...
    expect(screen.getByText("240+ AGENTS BUILD IT")).toBeInTheDocument();
...
describe("Landing Page — Feature Cards", () => {
  it("renders all 6 feature cards", () => {
    ...
    expect(screen.getByText("240+ NAMED AGENTS")).toBeInTheDocument();
    expect(screen.getByText("23 SLASH COMMANDS")).toBeInTheDocument();
    expect(screen.getByText("21 CODE PATTERNS")).toBeInTheDocument();
  ...
  it("links to correct pages", () => {
    ...
    const agentsLink = screen.getByText("240+ NAMED AGENTS").closest("a");
