...
export const searchIndex: SearchEntry[] = [
  ...
  { title: "/sentinel", description: "Canonical name for /security (ADR-050) — Kenobi's OWASP audit", path: "/commands/sentinel", category: "Commands" },
  ...
  { title: "/engage", description: "Canonical name for /review (ADR-050) — Picard's pattern compliance review", path: "/commands/engage", category: "Commands" },
