...
export const commands: Command[] = [
  {
    ...
    whatHappens: [
      ...
      "Stark + Kusanagi scaffold the project (signature-first: read actual function signatures before writing calls)",
  ...
  },
  {
    ...
    whatHappens: [
      ...
      "Entity selector completeness check — every user-facing selector can handle entities that don't exist yet",
