...
export const subAgents: SubAgent[] = [
  ...
  { name: "Wong", role: "LESSONS.md loader — reads lessons at session start", universe: "star-trek", series: "Cross-Series" },
  ...
  { name: "Tuvok", role: "Security architecture design", universe: "star-trek", series: "Voyager" },
